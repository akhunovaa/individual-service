...
public class CachingConfig extends CachingConfigurerSupport {
    ...
    public RedisCacheManager cacheManager() {
        ...
        cacheConfigurations.put("individual-data", defaultCacheConfiguration.entryTtl(Duration.ofHours(1)));
        cacheConfigurations.put("user-data", defaultCacheConfiguration.entryTtl(Duration.ofHours(1)));
        cacheConfigurations.put("user-info-data", defaultCacheConfiguration.entryTtl(Duration.ofSeconds(45)));
        cacheConfigurations.put("user-application-secret", defaultCacheConfiguration.entryTtl(Duration.ofHours(1)));
        cacheConfigurations.put("user-bookmark-list", defaultCacheConfiguration.entryTtl(Duration.ofHours(1)));
        cacheConfigurations.put("user-picture", defaultCacheConfiguration.entryTtl(Duration.ofHours(1)));
