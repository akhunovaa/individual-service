...
import com.botmasterzzz.individual.config.ApplicationConfig;
import com.botmasterzzz.individual.config.SecurityConfig;
...
public class ApplicationInit implements WebApplicationInitializer {
    ...
    private static final String DISPATCHER_SERVLET_NAME = "dispatcher-individual-service";
